...
import watchImage from '../Images/Smart-watch.jpg';

const WatchDetails = ({ setProduct }) => {
  ...
  const handleAddToCart = () => {
    setProduct({
      ...
      total: totalPrice,
      description:
        "Track your health, steps, and sleep with this stylish and waterproof smart watch."
    });
  ...
  return (
    <div className="flex flex-col md:flex-row p-6 gap-8 max-w-5xl mx-auto mt-6 bg-white rounded-lg shadow">
      ...
      <div className="flex-1 space-y-5">
        <h2 className="text-3xl font-bold text-gray-800">Smart Watch</h2>
