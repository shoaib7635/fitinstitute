...
const SpeakerDetails = ({ setProduct }) => {
  const [quantity, setQuantity] = useState(1);
  const pricePerUnit = 29;
  ...
  const handleAddToCart = () => {
    setProduct({
      ...
      quantity: quantity,
      total: totalPrice,
      description: "Enjoy portable, wireless sound with deep bass and long battery life."
    });
  ...
  return (
    <div className="flex flex-col md:flex-row p-6 gap-8 max-w-5xl mx-auto mt-6 bg-white rounded-lg shadow">
      ...
      <div className="flex-1 space-y-5">
        <h2 className="text-3xl font-bold text-gray-800">Bluetooth Speaker</h2>
        <p className="text-gray-600">
          Enjoy portable, wireless sound with deep bass and long battery life. 
